        ...
        if phase == "train":
            ...
            for _ in range(self.ppo_cfg["ppo_epochs"]):  # PPO inner epoch, K
                for sub_td in dataloader:
                    ...
                    #tmp = pearsonr(value_pred.detach().flatten(), previous_reward.flatten())

                    #def load(path):
                    #    with open(path, 'rb') as f:
                    #        loaded_list = pickle.load(f)
                    #        return loaded_list
                    #lst = load("/autodl-fs/data/rl4co/record/lyu.pkl")
                    #lst.append(tmp)
                    #with open("/autodl-fs/data/rl4co/record/lyu.pkl", 'wb') as f:
                    #    pickle.dump(lst, f)
